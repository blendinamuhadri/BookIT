...
import com.service.interfac.IBookingService;
import com.service.interfac.IRoomService;
...
public class RoomController {
    ...
    Response response = roomService.getAvailableRoomsByDataAndTypes(checkInDate, checkOutDate, roomType);
    return ResponseEntity.status(response.getStatusCode()).body(response);
}
